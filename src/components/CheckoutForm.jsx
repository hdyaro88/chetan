            ...
            <Row>
              ...
              <col lg={12}>
                <div>
                  ...
                  <input type="number, text" className="form-control" placeholder="Flat No./House" />
                  <input type="text" className="form-control" placeholder="Street" />
                  <input type="text, number" className="form-control" placeholder="Landmark" />
                  <input type="number" className="form-control" value="313001" disabled />
