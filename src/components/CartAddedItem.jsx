...
const CartAddedItem = ({ id, img, title, price, qty, total }) => {
  ...
  return (
    <div className="border h-36 rounded flex w-full font__5  ">
      ...
      <div className="px-3 md:p-3 w-full min-w-210">
        <div className="flex justify-between items-center">
          <h1 className="text-xl md:whitespace-nowrap font-semibold text-pink-50">
            {title}
          </h1>
          <div onClick={()=>dispatch(deleteCartProduct(id))} className="text-white hover:text-white cursor-pointer hover:bg-red-600 p-1 rounded-full hover:scale-105 transition-all">
            <MdOutlineDelete />
          </div>
        </div>
        ...
        <div className="flex my-3 md:items-center flex-col md:flex-row jus">
          <div className="flex items-center">
            <button
              className="w-auto  bg-red-400 px-2 py-1 rounded"
            ...
            <button
              className="w-auto  bg-green-400 px-2 py-1 rounded"
          ...
          <div className=" flex ml-0 md:ml-auto md:px-3 items-center">
            ...
            <span className=" font-semibold px-2 py-1 text-pink-50">
              <span>₹ </span>
              {total}
            </span>
          </div>
